...
$class = 'app-list scroll-refresh';
$title = '技术与应用分类列表';
$keywords = '技术与应用分类列表';
$description = '技术与应用分类列表';
...
?>
  ...
  <div id="main" class="ui-refresh">
    <nav class="pagenav">
      <ul>
        <li><a href="#">全部</a> <a href="#">新闻</a> <a href="#">新品</a> <a href="#">市场</a> <a href="#">应用与方案</a></li>
      </ul>
    </nav>
